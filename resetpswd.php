...
<body>
    <h1 align='center' style=" padding-block: 1em; color:#FFECD6;font-weight: bold;font-family:'Times New Roman', Times, serif; background:#4CB9E7">KOK COURIER SERVICE</h1>
    ...
    <div><h5 ><a href="index.php" style="float: right; margin-right:40px; color:blue; margin-top:0px">SignIn</a></h5></div>
        <div class="container" style="margin-top: 60px; width:50%;">
            <div class="row">
                <div class="col-md-12">
                    <h2 style="">Verify The Following Details</h2>
                    <p style="color: red">To Reset Your Password</p>
